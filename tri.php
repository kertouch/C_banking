...
require_once("connexion.php");
	...
	$sql1="select * from banque b,compte c,paiement p,monetique m where b.id_banque=c.id_banque and b.id_banque=p.id_banque and b.id_banque=m.id_banque order by $pres_detail;";
